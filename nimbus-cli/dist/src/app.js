...
import { ensureDirectoryExists, initializeModelsConfig, readModelsConfig, updateModelsConfig, removeModelFromConfig, removeModelDirectory, copyModelDirectory } from './utils/fileSystem.js';
async function main() {
